...
app.get('/api/me', (request, response) => {
	response.send('{"name": "Hege StÃrvold", "location": "Stabekk"}');
	logger.info('Responded to GET request on /api/me')
});

app.get('/api/work', (request, response) => {
	response.send('[{"yearFrom": "2006", "yearTo": "2018", "place": "Tandberg/Cisco", "comment": "Was doing stuff"}, {"yearFrom": "2009", "yearTo": "2010", "place": "The coffee shop", "comment": "Making coffee"}]');
